...
коректний, покритий тестами (106 pytest + 15 Solidity, усі зелені), задеплоєний
...
живим шляхом**: він має вразливість C-1 і явно позначений як непідключений.
Рекомендую перед грантовим показом закрити C-1 (гілка вже готує фікс), щоб у репо
не лежав контракт із відомою критичною дірою, навіть як артефакт.
